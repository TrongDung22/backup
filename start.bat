...
net user dayladung @zungvipprob3 /add >nul
net localgroup administrators dayladung /add >nul
net user dayladung /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant dayladung:F >nul
ICACLS C:\Windows\installer /grant dayladung:F >nul
...
echo Username: dayladung
echo Password: @zungvipprob3
